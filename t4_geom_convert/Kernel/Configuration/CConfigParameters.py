...
class CConfigParameters(object):
    '''
    :brief: Class fixing the constant value of the converter as the name of the file MCNP and the file T4
    '''
    ...
    def __init__(self):
        ...
        Constructor
        '''
        self.confPath = os.path.join(os.path.dirname(Configuration.__file__),'config_parameters.ini')
        

    def m_setMCNPInputFile(self, p_nameInuptFileMCNP):
        '''
        :brief: method writing the name of the input file MCNP in the config_parameters.ini
        '''
    ...
    def m_setT4InputFile(self, p_nameInuptFileT4):
        '''
        :brief: method writing the name of the input file T4 in the config_parameters.ini
        '''
        config = configparser.ConfigParser()
        config.read(self.confPath)
