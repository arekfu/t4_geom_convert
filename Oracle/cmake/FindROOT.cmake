...
if(T4_ROOT_INSTALL_DIRS)
  message(STATUS "Will look for ROOT in ${T4_ROOT_INSTALL_DIRS}")
endif()

find_program(ROOT_CONFIG_EXECUTABLE root-config
  PATHS ENV ROOTSYS ${T4_ROOT_INSTALL_DIRS}
  PATH_SUFFIXES bin)
...
find_package_handle_standard_args(ROOT
  REQUIRED_VARS ROOT_CONFIG_EXECUTABLE ROOTSYS ROOT_VERSION ROOT_INCLUDE_DIR ROOT_LIBRARIES ROOT_LIBRARY_DIR
  HANDLE_COMPONENTS)
