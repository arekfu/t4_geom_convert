...
class CTransformationMCNP(object):
    '''
     :brief: Class which permit to access precisely to the information of the transformation part of the block DATA
    '''
    ...
    def __init__(self, l_originTransformation, l_rotationTransformation):
        '''
        Constructor
        :param: l_originTransformation : list of the coordinates points of the new cartesian axes  
