...
class CCompositionMCNP(object):
    '''
    :brief: Class which permit to access precisely to the information of the part material of the block DATA
    '''
    ...
    def __init__(self, l_materialCompositionParameters):
        '''
        Constructor
        :param: l_materialCompositionParameters : list of composition of material with id of isotope and its abondance
        '''
