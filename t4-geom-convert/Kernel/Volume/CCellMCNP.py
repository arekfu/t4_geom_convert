...
class CCellMCNP(object):
    '''
    :brief: Class which permit to access precisely to the information of the block CELLS
    '''


    def __init__(self, p_materialID, p_density, syntaxTreeMCNP, p_importance, p_universe=0, fill=None):
        '''
        Constructor
